...
mkdir -p .claude/skills/handoff .claude/skills/catchup .claude/hooks .osmosis/journal
cp "$SRC/skills/handoff/SKILL.md"  .claude/skills/handoff/SKILL.md
cp "$SRC/skills/catchup/SKILL.md"  .claude/skills/catchup/SKILL.md
